...
//		addOwnerObject.addOwner("Mahran", "Sahran" + executionTime, "berlinerstr", "bochum", "2345678");
...
//		findOwnerObject.openAddOwnerPage();
//		AddOwnersPage addOwnerObject = new AddOwnersPage(driver);
//		addOwnerObject.addOwner("Shawal", "Ramdan" + executionTime, "berlinStr", "Wattenscheid", "5464654");
//		// check adding owner in OnwerInformation
//		OwnerInformationPage ownerInformationObject = new OwnerInformationPage(driver);
...
//		findOwnerObject.openAddOwnerPage();
//		AddOwnersPage addOwnerObject = new AddOwnersPage(driver);
//		addOwnerObject.addOwner("Tamer", "Kady" + executionTime, "kölnerstr", "bambenberg", "7555443");
//		// check adding owner in OnwerInformation
//		OwnerInformationPage ownerInformationObject = new OwnerInformationPage(driver);
