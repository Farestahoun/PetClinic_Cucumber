...
//		addOwnerObject.addOwner("Maher", "Mohamed" + executionTime, "Baustr", "dortmund", "65839396");
...
//		findOwnerObject.openAddOwnerPage();
//		AddOwnersPage addOwnerObject = new AddOwnersPage(driver);
//		addOwnerObject.addOwner("Hamda", "Ibrahim" + executionTime, "Tahounstr", "omarnia", "5637347");
...
//		findOwnerObject.openAddOwnerPage();
//		AddOwnersPage addOwnerObject = new AddOwnersPage(driver);
//		addOwnerObject.addOwner("Huda", "Shich" + executionTime, "ShichStr", "Bamberg", "64577875");
//		// check adding in OnwerInformation
//		OwnerInformationPage ownerInformationObject = new OwnerInformationPage(driver);
